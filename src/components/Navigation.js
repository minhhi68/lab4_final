...
export default function Navigation() {
    ...
    return (
        <div style={{ position: "relative" }}>
            <Navbar
                alignLinks="left"
                brand={<Link to="/"><span style={{ fontFamily: 'Merienda', fontWeight: 'lighter' }}></span></Link>}
            ...
            >
                <NavLink to="/" end style={({ isActive }) => isActive ? activeStyle : {}}><></>Hot Movies</NavLink>
                <NavLink to="/news" style={({ isActive }) => isActive ? activeStyle : {}}><></> Recent News</NavLink>
                <NavLink to="/about" style={({ isActive }) => isActive ? activeStyle : {}}><></>About Us</NavLink>
                <NavLink to="/contact" style={({ isActive }) => isActive ? activeStyle : {}}><></>Contact Us</NavLink>
            </Navbar>
            <Switch
